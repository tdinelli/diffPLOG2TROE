...
np.savetxt(os.path.join(data_directory, "falloff_troe_n2.csv"), k_matrix, delimiter=";", fmt="%.15e")
...
np.savetxt(os.path.join(data_directory, "falloff_troe_n2_h2o.csv"), k_matrix, delimiter=";", fmt="%.10e")
...
np.savetxt(os.path.join(data_directory, "falloff_troe_n2_o2_h2o.csv"), k_matrix, delimiter=";", fmt="%.10e")
