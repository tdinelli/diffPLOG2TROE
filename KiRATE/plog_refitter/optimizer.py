...
class PlogOptimizer:
    ...
    def optimize(
        ...
        active_lower = lower_bounds[self.active_indices]
        active_upper = upper_bounds[self.active_indices]
        ...
        for i in range(1, max_iterations + 1):
            active_params, opt_state, loss, grad = self._optimization_step(
                active_params,
                opt_state,
                active_lower,
                active_upper,
            ...
            # Log progress
            if self.logger and (i % 200 == 0 or i == max_iterations):
    ...
    def _compute_loss(self, params: Array) -> Float64:
        ...
        k_fitted = self.model.compute_rate_constants(full_params, self.param_names, self.T_range, self.P_range)
    ...
    @partial(jit, static_argnums=(0,))
    def _optimization_step(self, active_params, opt_state, lower_bounds, upper_bounds):
