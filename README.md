...
$$CH_3+CH_3(+M) \leftrightarrow C_2H_6(+M)$$
. As the pressure rises, deactivating collisions of
$$C_2H_6^*$$
with other molecules result in an increase in the rate coefficient for C2H6 formation. Concurrently,
these deactivating collisions preclude the dissociation of
$$C_2H_6^*$$
into
$$C_2H_5 + H$$
, thereby causing this rate coefficient to decrease with increasing pressure. Similarly,
chemically-activated reactions are described by a blending between a low-pressure and a
high-pressure rate expression, as is the case with falloff reactions. The distinction lies in the
manner of expression, whereby the forward rate constant is written as being proportional to the
